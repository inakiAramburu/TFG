...
variables["MYSQL_ROOT_PASSWORD"]="Maite123"
variables["MYSQL_DATABASE"]="patient_db"
variables["MYSQL_USER"]="patient_user"
variables["MYSQL_PASSWORD"]="patient_password"
variables["DATABASE_HOST"]="127.0.0.1"
variables["DATABASE_PORT"]="3306"
...
echo "  name: patient-api-secret" >> devops/pods/secrets.yaml
